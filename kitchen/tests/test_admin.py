...
class ModelsTests(TestCase):
    ...
    def test_cook_str(self):
        """Test that Cook string representation is correct"""
    ...
    def test_cook_get_absolute_url(self):
        """Test that Cook get_absolute_url returns correct path"""
        cook = get_user_model().objects.create_user(
            username="test_user",
            password="password123",
            years_of_experience=5,
    ...
    def test_dish_str(self):
        """Test that Dish string representation is correct"""
    ...
    def test_create_cook_with_experience(self):
        """Test that Cook is created with correct years of experience"""
        username = "chef_pro"
        years = 10
        cook = get_user_model().objects.create_user(
            username=username,
